...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pycollo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13905&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pycollo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pycollo` can be installed with:

```
conda install pycollo
```

It is possible to list all of the versions of `pycollo` available on your platform with:
